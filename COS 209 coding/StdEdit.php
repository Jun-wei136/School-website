...
<html>
    <head>
	    <meta charset="utf-8">
    	<title>Changing Personal Info</title>
    ...
    <body>
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST")
        {
            ...
            {
                $guard_error = "Guardian's phone number cannot be blanked!";
            }
            else
            {
            ...
            if($name_error == "" && $email_error == "" && $phone_error == "" && $address_error == "" && $dob_error == "" && $gender_error == "" && $nation_error == "" && $father_error == "" && $guard_error == "")
            {
                ...
                $query = "UPDATE $table_name SET Aname='".$name."', Aemail='".$email."' WHERE Aid=(SELECT Aid FROM $table_name1 WHERE Sid='$_SESSION[sess_sid]')";
                mysqli_query($conn, $query);

                $query1 = "UPDATE $table_name1 SET PhoneNo='".$phone."', Address='".$address."', DOB='".$dob."', Gender='".$gender."', Nationality='".$nation."', FatherName='".$father."', GuardianPhoneNo='".$guard."' WHERE Sid='$_SESSION[sess_sid]'";
        ...
        <div class="wrapper">
            <div class="sidebar">
                ...
                <ul>
                    ...
                    <li><a href="#" class="small-list">Edit Profile Information</a></li>
                            ...
                            <div class="wrap">
                                <div class="left-wrap">
                                    <div class="edit-form-group">
                                        <p>Name</p>
                                        <input type="text" name="s_name" class="edit-form-control" value="<?php echo $_SESSION['sess_name'] ?>">
                                    </div>
                                    <?php
                                    if(!empty($name_error))
                                    {
                                ...
                                <div class="right-wrap">
                                    ...
                                    <div class="edit-form-button">
                                        <button type="submit" class="edit-form-submit-button">Sign Up</button>
                                    </div>
                                </div>
                            </div>
                        </form>
